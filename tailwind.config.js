  ...
  theme: {
    extend: {
      colors: {
        ...
        // Student theme - bright and motivational (blue/teal/green)
        student: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Teacher theme - professional (navy blue + orange)
        teacher: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        // Admin theme - clean and data-driven (dark blue + cyan/purple)
        admin: {
          50: '#fdf4ff',
          100: '#fae8ff',
          200: '#f5d0fe',
